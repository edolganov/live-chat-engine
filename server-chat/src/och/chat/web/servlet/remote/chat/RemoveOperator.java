...
@WebServlet(URL_CHAT_REMOVE_OP)
@SuppressWarnings("serial")
public class RemoveOperator extends EncryptedJsonPostServlet<RemoveOperatorReq, Void> {
	
	@Override
	protected Void doJsonPost(HttpServletRequest req, HttpServletResponse resp, RemoveOperatorReq data) throws Throwable {
		
		pushToSecurityContext_SYSTEM_USER();
		try {
			
			chats.removeOperator(data.accountId, data.userId);
			return null;
