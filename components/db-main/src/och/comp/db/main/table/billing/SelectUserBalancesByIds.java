...
public class SelectUserBalancesByIds extends SelectRows<UserBalance>{

	public SelectUserBalancesByIds(Collection<Long> userIds) {
		super(users, 
				UserBalance.class, 
				new BalanceFields(), 
				new InCondition(Id.class, userIds));
	}
