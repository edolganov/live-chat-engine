...
public class DeleteChatAccountPrivilege extends DeleteRows {

	public DeleteChatAccountPrivilege(long userId, long accId) {
		super(chat_account_privileges, 
			new AndCondition(new UserId(userId), new AccId(accId)));
	}
