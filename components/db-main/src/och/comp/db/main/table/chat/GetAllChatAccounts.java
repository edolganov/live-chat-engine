...
public class GetAllChatAccounts extends SelectRows<ChatAccount>{

	public GetAllChatAccounts() {
		super(chat_accounts, ChatAccount.class, new ChatAccountFields(), null);
	}
