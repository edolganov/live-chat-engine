...
import och.comp.db.main.table._f.AccsBlocked;
import och.comp.db.main.table._f.Id;



public class UpdateUserAccsBlocked extends UpdateRows {

	public UpdateUserAccsBlocked(long userId, boolean val) {
		super(users, 
				new AndCondition(new Id(userId)), 
				new AccsBlocked(val));
	}
