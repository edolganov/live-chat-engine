...
public class UpdateUserBalance extends UpdateRows {

	public UpdateUserBalance(long userId, BigDecimal oldVal, BigDecimal newVal) {
		super(users, new AndCondition(new Id(userId), new Balance(oldVal)), new Balance(newVal));
	}
