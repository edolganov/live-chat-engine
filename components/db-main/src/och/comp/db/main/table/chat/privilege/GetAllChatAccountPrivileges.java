...
public class GetAllChatAccountPrivileges extends SelectRows<ChatAccountPrivileges>{

	public GetAllChatAccountPrivileges() {
		super(chat_account_privileges, ChatAccountPrivileges.class, 
				new ChatAccountPrivilegesFields(), null);
	}
