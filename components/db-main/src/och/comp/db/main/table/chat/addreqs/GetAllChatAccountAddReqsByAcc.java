...
public class GetAllChatAccountAddReqsByAcc extends SelectRows<ChatAccountAddReq>{

	public GetAllChatAccountAddReqsByAcc(long accId) {
		super(chat_account_addreqs, ChatAccountAddReq.class, 
				new ChatAccountAddReqFields(), 
				new AndCondition(new AccId(accId)));
	}
