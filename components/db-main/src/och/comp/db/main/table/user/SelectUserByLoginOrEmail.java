...
import och.comp.db.base.universal.query.OrCondition;
import och.comp.db.main.table._f.Email;
import och.comp.db.main.table._f.Login;



public class SelectUserByLoginOrEmail extends SelectRows<UserExt>{

	public SelectUserByLoginOrEmail(String val) {
		super(users, 
				UserExt.class, 
				new UserExtFields(), 
				new OrCondition(
