...
import och.comp.db.main.table._f.ChatPrivileges;
import och.comp.db.main.table._f.UserId;

public class UpdateChatAccountPrivileges extends UpdateRows {

	public UpdateChatAccountPrivileges(long chatId, long userId, Set<PrivilegeType> privileges) {
		super(chat_account_privileges, 
				new AndCondition(
						new AccId(chatId),
						new UserId(userId)),
				new ChatPrivileges(privileges));
	}
