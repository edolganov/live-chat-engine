...
public class BaseClientInitializer extends BaseFileConfigInitializer {
	
	CacheClient cache;
	String lastModifiedKey; 
	String contentKey;

	public BaseClientInitializer(CacheClient cache, String filePath, String lastModifiedKey, String contentKey) {
		super(filePath);
		this.cache = cache;
	...
	protected void setContent(long lastModified, String content) throws Exception {
		cache.putCache(lastModifiedKey, Long.toString(lastModified));
		cache.putCache(contentKey, content);
	}
