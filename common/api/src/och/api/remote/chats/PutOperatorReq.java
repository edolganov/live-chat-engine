...
public class PutOperatorReq extends BaseBean {
	...
	public PutOperatorReq() {
		super();
	}
	
	public PutOperatorReq(String accountId, long userId, String name) {
		this(accountId, userId, name, null);
	}


	public PutOperatorReq(String accountId, long userId, String name, String email) {
	...
	public ChatOperator getOperator(){
		return new ChatOperator(userId, name, email);
	}
