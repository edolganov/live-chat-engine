...
public class SetAccsPausedReq extends BaseBean {
	
	public List<String> accs;
	public Boolean val;
	

	public SetAccsPausedReq() {
	}
	
	public SetAccsPausedReq(String acc, Boolean val) {
		this(list(acc), val);
	}

	public SetAccsPausedReq(Collection<String> accs, Boolean val) {
