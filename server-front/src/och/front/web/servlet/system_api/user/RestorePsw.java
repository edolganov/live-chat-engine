...
@WebServlet("/system-api/user/psw-restore")
@SuppressWarnings("serial")
public class RestorePsw extends JsonPostServlet<RestorePswReq, Void>{
	...
	protected Void doJsonPost(HttpServletRequest req, HttpServletResponse resp,
			RestorePswReq data) throws Throwable {
		
		app.users.generateNewPassword(data.email);
