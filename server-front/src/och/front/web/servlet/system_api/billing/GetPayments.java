...
@RoleSecured
@WebServlet("/system-api/billing/payments")
@SuppressWarnings("serial")
public class GetPayments extends JsonPostServlet<GetPaymentsReq, GetPaymentsResp> {
	
	@Override
	protected GetPaymentsResp doJsonPost(HttpServletRequest req, HttpServletResponse resp, GetPaymentsReq data) throws Throwable {
		
		BigDecimal balance = billing.getCurUserBalance();
		List<PaymentExt> list = billing.getPayments(DEFAULT_PAGE_LIMIT, data.page * DEFAULT_PAGE_LIMIT);
