 ...
 */
package och.front.web.servlet.system_api;
...
@RoleSecured
@WebServlet("/system-api/ping")
@SuppressWarnings("serial")
public class PingFront extends JsonPostServlet<EmptyReq, Void> {
	...
	protected Void doJsonPost(HttpServletRequest req, HttpServletResponse resp, 
			EmptyReq data) throws Throwable {
