...
@RoleSecured
@WebServlet("/system-api/chat/deleteUser")
@SuppressWarnings("serial")
public class DeleteAccUser extends JsonPostServlet<DeleteUserReq, Void> {
	
	@Override
	protected Void doJsonPost(HttpServletRequest req, HttpServletResponse resp, DeleteUserReq data) throws Throwable {
		...
		if(curPrivs.contains(CHAT_MODER)) privsToDelete.add(CHAT_MODER);
		if(curPrivs.contains(CHAT_OPERATOR)) privsToDelete.add(CHAT_OPERATOR);
