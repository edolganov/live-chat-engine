...
@RoleSecured
@WebServlet("/system-api/chat/putAccConfig")
@SuppressWarnings("serial")
public class PutAccConfig extends JsonPostServlet<PutAccConfigReq, Void> {
	
	@Override
	protected Void doJsonPost(HttpServletRequest req, HttpServletResponse resp, PutAccConfigReq data) throws Throwable {
		
		chats.putAccConfigByUser(data.accId, data.keyVal, data.val);
